...
namespace AiModel
{
    public partial class Test3
    {
        ...
        private static string MLNetModelPath = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "Test3.zip");
