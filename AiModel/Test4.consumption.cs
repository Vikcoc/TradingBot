...
namespace AiModel
{
    public partial class Test4
    {
        ...
        private static string MLNetModelPath = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "Test4.zip");
