...
using Dapper;
using static DataExporter.Scripts.Script8;
...
namespace DataExporter.Scripts
{
    public class Script9
    {
        ...
        public static void Run()
        {
            ...
            var a = new SimpleCsvWriter("ma-ta10.csv");
            ...
            foreach (var day in days)
            {
                ...
                {
                    a.AddRow(new[]{day.Skip(i-51).Take(50).Average(x => x.Actual), day.Skip(i).First().Actual, day.Skip(i).Take(20).Average(x => x.Actual) }
