...
{
    public class TradingEthHandler5 : ICryptoComDtoExecutor
    {
        ...
        public TradingEthHandler5(CryptoComBalanceDto balanceDto, SecondPass debouncePass, IDbConnection connection, ILogger<TradingEthHandler5> logger)
        {
