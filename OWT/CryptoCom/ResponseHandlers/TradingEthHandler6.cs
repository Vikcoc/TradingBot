...
{
    public class TradingEthHandler6 : ICryptoComDtoExecutor
    {
        ...
        public TradingEthHandler6(CryptoComBalanceDto balanceDto, SecondPass debouncePass, IDbConnection connection, ILogger<TradingEthHandler5> logger)
        {
        ...
        public async Task Execute(JObject dto, CryptoComMarketClient marketClient, CancellationToken token)
        {
            ...
            var sampleData = new DailyTradeModel.ModelInput()
            {
            ...
            var result = DailyTradeModel.Predict(sampleData);
