...
namespace OWT.CryptoCom.ResponseHandlers 
{
    public class TickerSaveHandler : ICryptoComDtoExecutor
    {
        ...
        private const string InsertQuery = "INSERT INTO [MarketStateSnaps] ([DateTime], [InstrumentName], [BestBid], [BestAsk], [Actual], [Low], [High], [Volume], [Change], [Timestamp], [BigVolume], [PartChange]) VALUES (@param1, @param2, @param3, @param4, @param5, @param6, @param7, @param8, @param9, @param10, @param11, @param12)";
        private const string SelectQuery = "SELECT TOP (1) [Actual] AS Value FROM [MarketStateSnaps] ORDER BY [DateTime] DESC";
